...
$pass = "";          // your MySQL password (keep empty for XAMPP)
$db   = "madhu_db";     // your database name
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = $conn->prepare("SELECT fullname, email, password FROM login WHERE email = ?");
    ...
    <main class="flex-1 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
        <div class="max-w-md w-full space-y-8">
            ...
            <div class="text-center">
                ...
                <h2 class="font-['Playfair_Display'] text-3xl font-bold text-stone-800 mb-2">Welcome Back</h2>
                <p class="text-stone-600">Sign in to your Loomscape account</p>
            </div>
           ...
           <form method="POST" class="mt-8 space-y-6">
                        ...
                        <div class="flex items-center justify-between">
                            <div class="flex items-center">
                                <input id="remember-me" name="remember-me" type="checkbox"
                                    class="w-4 h-4 text-primary focus:ring-primary border-stone-300 rounded">
                                <label for="remember-me" class="ml-2 block text-sm text-stone-700">Remember me</label>
                            </div>
                            <div class="text-sm">
                                <a href="#"
                                    class="text-primary hover:text-secondary transition-colors duration-300">Forgot
                                    password?</a>
                            </div>
                        </div>
                ...
                <div class="text-center">
                    <p class="text-stone-600">
                        ...
                        <a href="signin.html"
                            class="text-primary hover:text-secondary font-medium transition-colors duration-300">Sign up
                            here</a>
                    </p>
                </div>
            </form>
